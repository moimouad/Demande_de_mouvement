...
<body>
	...
	<div class="container-contact100">
		<div class="wrap-contact100">
			<form class="contact100-form validate-form" method="post" action="ch_p">
				...
				<div class="wrap-input100 validate-input" data-validate="Poste actuel is required">
					<span class="label-input100">Poste actuel :</span>
					<input class="input100" type="text" name="poste_act" placeholder="Enter votre poste" required>
					<span class="focus-input100"></span>
				</div>
				
				<div class="wrap-input100 validate-input" data-validate="Poste is required">
					<span class="label-input100">Poste Demandé :</span>
					<input class="input100" type="text" name="poste_dem" placeholder="Enter le poste" required>
					<span class="focus-input100"></span>
				</div>
				
				<div class="wrap-input100 validate-input" data-validate="Id is required">
					<span class="label-input100">Id du Permutant :</span>
					<input class="input100" type="text" name="id_permutant" placeholder="Enter le Id" required>
					<span class="focus-input100"></span>
				</div>
