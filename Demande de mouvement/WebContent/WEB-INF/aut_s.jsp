...
<body>
	...
	<div class="container-contact100">
		<div class="wrap-contact100">
			<form class="contact100-form validate-form" method="post" action="aut_s">
				...
				<div class="wrap-input100 validate-input" data-validate="Heure is required">
					<span class="label-input100">L'Heure : </span>
					<input class="input100" type="text" name="heure" placeholder="HH : MM" required>
					<span class="focus-input100"></span>
				</div>
