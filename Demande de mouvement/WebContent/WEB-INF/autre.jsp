...
<body>
	...
	<div class="container-contact100">
		<div class="wrap-contact100">
			<form class="contact100-form validate-form" method="post" action="autre">
				...
				<div class="wrap-input100 validate-input" data-validate="Poste actuel is required">
					...
					<input class="input100" type="text" name="objet" placeholder="Enter l'objet " required>
					<span class="focus-input100"></span>
				</div>
				
				<div class="wrap-input100 validate-input" data-validate="Poste is required">
					<span class="label-input100">Description :</span>
					<input class="input100" type="text" name="desciption" placeholder="Enter la description" required>
					<span class="focus-input100"></span>
				</div>
